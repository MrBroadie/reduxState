...
export const updateSupplierStoreList = (bookList) => {
...
export const updateBooksInBasket = (booksInBasket) => {
...
export const updateDashboard = (booksInBasket) => {
...
const bookItemElementClass = (element) => {
    element.classList.add("text-gray-800", "p-4", "m-2", "border-b", "border-gray-200", `bg-blue-100`, "flex", "flex-col", "justify-between", "items-center", "space-x-4");
};
const addToBasketButton = (element) => {
    element.classList.add("bg-blue-500", "text-white", "p-4", "mt-2", "rounded");
};
const removeFromBasketButton = (element) => {
